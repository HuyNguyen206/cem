...
<html lang="en">
			...
			<div class="navbar-container" id="navbar-container">
				...
				<div class="navbar-header pull-right" role="navigation">
					<ul class="nav ace-nav">
						<li class="light-blue">
							<a title="{{trans('nav-sidebar.ChangeToVietnamese')}}" style="{{(App::getLocale() == 'vi') ? 'background-color: powderblue;' : ''}}" href="{{url('/lang/vi')}}"><img class="emo-resize" style="width: 20px;" src="{{asset("assets/img/viFlag.png")}}"></a>
						</li>
						<li class="light-blue">
							<a title="{{trans('nav-sidebar.ChangeToEnglish')}}" style="{{(App::getLocale() == 'en') ? 'background-color: powderblue;' : ''}}" href="{{url('/lang/en')}}"><img class="emo-resize" style="width: 20px;" src="{{asset("assets/img/enFlag.png")}}"></a>
						</li>
						<li class="light-blue">
    ...
    margin-bottom: auto;
    height: 30px;
    position: fixed;" id="btn-scroll-up" class="btn-scroll-up btn btn-sm btn-inverse">
