                                        ...
                                        @if($values->region === $val['zone_name'])
                                            @if(!empty($values->branchcode))
                                                <tr>
                                                    <td class="center">
                                                        <label>
                                                            <input type="checkbox" class="ace" id="{{'area-'. $values->area_id_plus .'plus'}}" name="zone_{{$val['zone_id']}}[]" value="{{$values->area_id_plus}}"/>
                                                            <span class="lbl"></span>
                                                        </label>
                                                    </td>
...
<script type="text/javascript">
    ...
    function changeUser() {
        ...
        var brand = [<?php foreach ($brand as $val) {
        ...
        var userbrandplus = [<?php foreach ($userrole as $val) {
