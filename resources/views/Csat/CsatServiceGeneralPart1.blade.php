...
<div class="table-responsive">
    <div class="row text-center" style="padding: 10px">
        <text x="910" text-anchor="middle" class="highcharts-title" zIndex="4" style="color:#333333;font-size:18px;fill:#333333;width:1756px;" y="24">
            ...
            <br/>
            <span>Tổng hợp CSAT 1,2 chất lượng dịch vụ Internet và Truyền hình</span>
            <br/>
...
<div id="viewLocation" @if($viewStatus == 1) style="display: none;" @endif>
    <div>
        <h3 class="header smaller lighter red">
            ...
            <b>Thống kê CSAT 1,2 CLDV theo các điểm tiếp xúc</b><br/>
        </h3>
        <h4 class="smaller red">
            <b>1. Đối với CSAT 1,2 CLDV Internet</b><br/><br/>
        </h4>
        <div>
            <table width="100%">
                <thead>
        ...
        <br/>
        <h4 class="smaller red">
            <b>2. Đối với CSAT 1,2 CLDV Truyền hình</b><br/><br/>
        </h4>
        <div>
            <table width="100%">
                <thead>
        ...
        <h3 class="header smaller lighter red">
            <i class="icon-table"></i>
            <b>Thống kê Nguyên nhân và Hành động xử lý CSAT 1,2 CLDV bởi nhân viên CSKH Happy Call</b><br/>
        </h3>
        <?php $department = $cs; ?>
        <h4 class="smaller red">
            <b>1. Đối với CSAT 1,2 CLDV Internet</b><br/><br/>
        ...
        <h3 class="header smaller lighter red">
            <i class="icon-table"></i>
            <b>Thống kê Nguyên nhân và Hành động xử lý CSAT 1,2 CLDV bởi nhân viên thu cước tại nhà</b><br/>
        </h3>
        <?php $department = $cus; ?>
        <h4 class="smaller red">
            <b>1. Đối với CSAT 1,2 CLDV Internet</b><br/><br/>
...
<div id="viewBranch" @if($viewStatus == 0) style="display: none;" @endif>
    <div>
        ...
        <h3 class="header smaller lighter red">
            <i class="icon-table"></i>
            <b>Thống kê Nguyên nhân và Hành động xử lý CSAT 1,2 CLDV bởi nhân viên CSKH</b><br/>
        </h3>
        <?php $department = $cs; ?>
        <h4 class="smaller red">
            <b>1. Đối với CSAT 1,2 CLDV Internet</b><br/><br/>
