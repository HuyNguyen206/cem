...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'sqlsrv_voice_cam_1' => [
            'driver'   => 'sqlsrv',
            'host'     => env('DB_HOST', '172.27.16.71'),
            'database' => env('DB_DATABASE', ' vclogdb'),
            'username' => env('DB_USERNAME', 'cem_isc'),
            'password' => env('DB_PASSWORD', 'Isc@123'),
            'charset'  => 'utf8',
            'prefix'   => '',
        ],
