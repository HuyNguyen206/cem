...
class OutboundAccount extends Model {
    ...
    protected $fillable = [
        ...
        'so_hd', 'ngay_tao_hd', 'ten_truy_cap', 'email', 'phone', 'dia_chi_lap_dat', 'dia_chi_thanh_toan', 'kh_tiep_nhan_ld', 'kh_su_dung_internet', 'kh_su_dung_truyenhinh', 'user_created', 'date_entered', 'user_gender', 'payment_type', 'payment_account', 'contact_person', 'birthday', 'supporter', 'sub_supporter'];
